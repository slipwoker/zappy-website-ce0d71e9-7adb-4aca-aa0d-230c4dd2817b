document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value !== '') {
        ...
        if (field.hasAttribute('maxlength')) {
          ...
          if (value.length > max) {
            showFieldError(field, label + ' must not exceed ' + max + ' characters.');
            return false;
          }
        }
      }
    ...
    const validatableSelectors = 'input:not([type="hidden"]):not([type="submit"]):not([type="button"]):not([type="reset"]), textarea, select';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ce0d71e9-7adb-4aca-aa0d-230c4dd2817b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ce0d71e9-7adb-4aca-aa0d-230c4dd2817b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ce0d71e9-7adb-4aca-aa0d-230c4dd2817b';
